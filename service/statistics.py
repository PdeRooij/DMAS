...
class Statistics:
    ...
    def update(self, driver_list):
        ...
        for driver in self.drivers:
            ...
            if driver.view == [1, 0, 0] and driver.act == 'go':
                self.stats[0] += 1
            elif driver.view == [1, 0, 0] and driver.act == 'wait':
                self.stats[2] += 1
            # Check if driver gave way to the right or did not
            elif driver.view == [0, 0, 1] and driver.act == 'go':
                self.stats[1] += 1
            elif driver.view == [0, 0, 1] and driver.act == 'wait':
                self.stats[3] += 1
